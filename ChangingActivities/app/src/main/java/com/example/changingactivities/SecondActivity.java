...
public class SecondActivity extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            Toast.makeText(SecondActivity.this,"User Registered Successfully", Toast.LENGTH_LONG).show();
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(SecondActivity.this,"Please Fill All The Required Fields.", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(SecondActivity.this,"Email Already Exists",Toast.LENGTH_LONG).show();
